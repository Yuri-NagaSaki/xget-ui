  ...
  en: {
    ...
    docs: {
      ...
      categories: {
        ...
        "ai-inference": "AI Inference Providers",
      ...
      containerTitle: "Container Registry Configuration",
      containerHint: "Configure Docker daemon to use Xget as registry mirror for accelerated image pulls",
      aiInferenceTitle: "AI Inference API Usage",
      aiInferenceHint: "Simply replace the API base URL to accelerate AI inference requests",
      gitCommands: {
      ...
      platformExamples: {
        ...
        dockerHub: "Pull Docker Hub image",
        ghcr: "Pull GitHub Container image",
        gcr: "Pull Google Container image",
        openai: "OpenAI Chat Completion API",
        anthropic: "Claude Messages API",
        gemini: "Gemini Generate Content API",
      },
    },
  },
  zh: {
    ...
    docs: {
      ...
      containerTitle: "容器镜像加速配置",
      containerHint: "配置 Docker daemon 使用 Xget 作为镜像加速源，加速容器镜像拉取",
      aiInferenceTitle: "AI 推理 API 使用",
      aiInferenceHint: "只需替换 API Base URL 即可加速 AI 推理请求",
      gitCommands: {
        clone: "克隆存储库",
        cloneBranch: "克隆指定分支",
      ...
      platformExamples: {
        ...
        dockerHub: "拉取 Docker Hub 镜像",
        ghcr: "拉取 GitHub Container 镜像",
        gcr: "拉取 Google Container 镜像",
        openai: "OpenAI Chat Completion API",
        anthropic: "Claude Messages API",
        gemini: "Gemini Generate Content API",
      },
